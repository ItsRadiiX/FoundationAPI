...
public class ItemStackCreator {
     ...
     */
    public ItemStackCreator(TextCreator textCreator, Material material) {
        this.textCreator = textCreator;
        this.result = new ItemStack(material);
        this.itemMeta = result.getItemMeta();
    }

    public ItemStackCreator(TextCreator textCreator, ItemStack item) {
        this.textCreator = textCreator;
        this.result = item;
        this.itemMeta = result.getItemMeta();
    }
     ...
     * @param player The player used to set placeholders with.
     * @return The ItemCreator instance.
     */
    public ItemStackCreator setName(String name, UUID player) {
        if (name == null || name.isBlank()) return this;
        itemMeta.displayName(textCreator.create(name, player));
        return this;
    }
    ...
    /**
     * Adds the lore to the ItemStack.
     *
     * @param components The list of lore components.
     * @return The ItemCreator instance.
     */
    public ItemStackCreator addLore(Component... components) {
        ...
        if (existingLore != null) {
            ...
            existingLore = Arrays.asList(components);
        }
    ...
    public ItemStackCreator addLore(List<Component> components) {
        List<Component> existingLore = itemMeta.lore();
        if (components == null) return this;
     ...
     * @return The ItemCreator instance.
     */
    public ItemStackCreator setLore(UUID uuid, Component... components) {
        if (components == null) return this;
     ...
     * @return The ItemCreator instance.
     */
    public ItemStackCreator setLore(UUID uuid, String... lore) {
        if (lore == null || lore.length == 0) return this;

        List<Component> loreComponents = new ArrayList<>();
        for (String line : lore) {
            loreComponents.add(textCreator.create(line, uuid));
        }
    ...
    public ItemStackCreator setLore(String lore, UUID uuid) {
        if (lore == null || lore.isEmpty()) return this;

        itemMeta.lore(List.of(textCreator.create(lore, uuid)));
        return this;
    }

    public ItemStackCreator setLore(String lore) {
        return setLore(lore, null);
    }
    ...
    public ItemStackCreator setSkullOwnerUUID(UUID uuid) {
        if (itemMeta instanceof SkullMeta meta) {
    ...
    public ItemStackCreator setSkullFromUrl(URL url) {
        ...
        return this.setSkullPlayerProfile(profile);
    }

    public ItemStackCreator setSkullFromUrl(String url) throws Exception {
        return this.setSkullFromUrl(new URI(url).toURL());
    }
